...
function ModelController(tick = 0, fps = 3, running = false, finished = false) {
    ...
    this.step = function step() {
        this.tick += 1;
        // var hour = Math.floor(this.tick/60)
        // var minutes = this.tick - hour * 60
        // var hourString = hour.toString().padStart(2,"0")
        // var minutesString = minutes.toString().padStart(2,"0")
        // var str = hourString + ':'+ minutesString
        // if (hour>23){
        //     var str = "Overtime"
        // }
        // stepDisplay.innerText = str;
        // if ([6,7,8,9,15,16,17,18].includes(hour) ){
        //     stepDisplay.innerText = str + " Rush hour"
        // } else{
        //     stepDisplay.innerText = str;
        // }
